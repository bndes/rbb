...
Para instalar os nós, seguir o procedimento da Lacchain: https://github.com/lacchain/bndes-network/blob/master/DEPLOY_NODE.md. Usar também esse [procedimento](detalhamento_comandos_Besu.md).
