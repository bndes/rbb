...
- Preencher, assinar e apresentar o [Termo de Adesão](documentos/Termo_de_Adesao_RBB.docx). Sobre o seu preenchimento:
  ...
  - Conforme o [Acordo de Cooperação](documentos/ACT_TCU_BNDES_RBB.pdf), Cláusula II, Inciso X, o partícipe deverá indicar representantes para acompanhar a execução do Acordo. Tais representantes devem estar definidos no Termo de Adesão.
...
- Entidades nacionais de direito privado sem fins lucrativos ou empresas estatais, federais, estaduais, municipais e distritais devem:
  ...
  - No caso de entidade de direito privado sem fins lucrativos, apresentar um relato da experiência da entidade na tecnologia blockchain de tal forma a atender à Cláusula II, Parágrafo IV, Inciso III do [Acordo de Cooperação](documentos/ACT_TCU_BNDES_RBB.pdf).
  - Quando cabível, preencher [declaração](documentos/Declaracao_Parte_Relacionada.docx) de que não é Parte Relacionada às Empresas do Sistema BNDES (em observância à Política para Transações com Partes Relacionadas do Sistema BNDES). Ser Parte Relacionada não impede a adesão à RBB.
